...
public class PostContactoProductor  extends AbstractHTTP{
	...
	protected Object procesarPeticionOK(BufferedReader in, AbstractJsonRestEstructura json, int responseCode) throws Exception {
	    ...
	    File fichero = DirectorioManager.getDirectorioFechaYHoraInicio(json.getConfEntidadPart(), nombreEntidad+CSVHandler.PATH_INSERTADOS_OK);
        String inputLine;
